...
```{r}
write.csv(imputed_data,"data/data_3_imputed_aggregated_beeps_TESTSET.csv")
```
...
```{r}
write.csv(aggregate_data_by_day,"data/data_4_aggregated_day_TESTSET.csv")
```
...
```{r}
write.csv(beep_new, "data/data_4_imputed_aggregated_beep_TESTSET.csv")
```
